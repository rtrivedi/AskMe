...
- (void)viewDidLoad {
    ...
    _objects = [NSMutableArray arrayWithObjects:@"Lorem Ipsum is simply dummy text  Ipsum is simply dummy text of the pr of the printing and typesettin",@"Check out the report and finalize it, please", nil];
